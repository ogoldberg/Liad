Refinery::Images.configure do |config|
  ...
  # Configure image sizes
   config.user_image_sizes = {:small=>"960x420>", :medium=>"960x540>", :large=>"960x960>"}
  ...
  # config.dragonfly_secret = "3a5418a76b91799928e37d5d5495da0c34078599bb99dc13"
  # If you decide to trust file extensions replace :ext below with :format
  # config.dragonfly_url_format = "/system/images/:job/:basename.:ext"
  # config.datastore_root_path = "/home/oren/src/rails_projects/liad/public/system/refinery/images"
